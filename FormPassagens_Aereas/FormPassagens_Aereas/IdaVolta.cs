...
{
    public partial class IdaVolta : Form
    {
        ...
        private void IdaVolta_Load(object sender, EventArgs e)
        {
            FillComboSeacrhCode();
        }
        ...
        {
            txbIda.Text = DateBoldEventArgs.Empty.ToString();
            txbVolta.Text = DateBoldEventArgs.Empty.ToString();
        }
